      ...
      <div className=" flex justify-center">
        <div className="flex justify-around flex-col items-center m-32  mt-14 rounded-xl bg-gray-200 shadow-xl ">
          ...
          <p className="m-12">
            ...
            Nostra placerat sagittis viverra sed fringilla senectus orci dis.
            Mus volutpat maximus justo luctus hendrerit. Iaculis inceptos rutrum
            habitant lacus blandit. Curae proin fringilla augue metus rhoncus
            fringilla platea. Iaculis lobortis at risus egestas aptent luctus
            eget litora. Fermentum consectetur lacus risus, fringilla eleifend
            placerat fames elementum. Mollis dolor primis ipsum, convallis
            condimentum vitae nisl. Torquent diam pulvinar facilisi at efficitur
            ac mus conubia.
          </p>
          ...
          <div className="w-4/5 m-12">
            <Gist
              className="w-max m-12"
              id="d3ef65356936d4687bd9b13193e46afc"
            />
          </div>
